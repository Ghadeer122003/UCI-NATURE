...
try:
    from server.scripts.config import SERVICE_ACCOUNT_FILE as DEFAULT_SERVICE_ACCOUNT_FILE
    from server.scripts.config import FOLDER_ID as DEFAULT_FOLDER_ID
    from server.scripts.config import MAX_DOWNLOADS as DEFAULT_MAX_ROWS
except Exception:
